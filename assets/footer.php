<div id="footer_contact">
    <footer class="footer">
        <ul id="footer1">
            ...
            <li>Follow us <img src="assets/images/facebook.png" class="pic_align2"><img src="assets/images/twitter.png"
                                                                                        class="pic_align2"></li>
        </ul>
    ...
    <!--                     class="--><?php //print($value['class']); ?><!--"> <img src="-->
    <?php //print($value['image2']); ?><!--"-->
